...
class Phones(Field):
    ...
    def value(self, value):
        try:
            ...
            print("Theres is must be only numbers")
...
class Birthday(Field):
    ...
    #             raise ValueError
    #         elif birthday_date <= date.today():
    #             self._value = birthday_date
    #         else:
    #             raise ValueError
    #     except ValueError:
    #         raise ValueError("Incorrect. Format yyyy.mm.dd")
    #     except TypeError:
    #         raise ValueError("Incorrect. Format yyyy.mm.dd.")
    @Field.value.setter
    def value(self, new_value: str):
    ...
    def iterator(self, value_1, value_2):
        ...
        for i in range(value_1, value_2 + 1):
            ...
            for k, v in self.data.items():
                a += 1
                if i == a:
                    # full_list.append(f"{k} have this numbers {[v.value for v in v.phones]}")
